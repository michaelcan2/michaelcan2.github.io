...
class GoRefereeInterface(with_metaclass(ContractsMeta, object)):
    ...
    @abstractmethod
    @contract(act='str', returns='(list[>=1,<=2](str)|None)')
    ...
    @abstractmethod
    @contract(returns='list[>=$MIN_HIST_LENGTH,<=$MAX_HIST_LENGTH](list[$BOARD_SIZE_X](list[$BOARD_SIZE_Y](str)))')
    def get_history(self, b):
        """
            Retrieves and returns the internal representation of the history for the game so far.
        """
        pass
